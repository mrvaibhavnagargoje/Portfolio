...
export function Projects() {
  const cards = [
    {
      ...
      title: "Modern Hub",
      thumbnail: modernImg,
      Githublink: "https://github.com/mrvaibhavnagargoje/E-commerce-website",
      Demolink: "https://modern-hub-ecommerce.onrender.com/",
      tech: [
  ...
  //   },
    {
      id: 4,
      title: "AI_ImageGenerator",
      thumbnail: AIgenerator,
